...
# Default origin when user specifies only destination, e.g. "Japan trip"
DEFAULT_ORIGIN_RAW = os.getenv("DEFAULT_ORIGIN_IATA", "DEL")
...
def parse_route(query: str):
    ...
    if len(mentions) == 1:
        ...
        default_origin = resolve_location_to_iata(DEFAULT_ORIGIN_RAW) or "DEL"
